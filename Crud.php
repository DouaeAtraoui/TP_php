        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><a onclick="confirmer(event)" class="btn btn-danger" href="Crud.php?delete=<?php echo $user['id']; ?>"data-toggle="tooltip"><i class="bi bi-x-circle"></i></a></td>
                    <td><a class="btn btn-warning" href="Crud.php?edit=<?php echo $user['id']; ?>"data-toggle="tooltip"><i class="bi bi-pencil-fill"></i></a></td>
                </tr>
            <?php
            endforeach; ?>
        </tbody>
